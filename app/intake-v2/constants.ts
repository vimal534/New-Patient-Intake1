...
> = {
  "new-infant": {
    scheduling: {
      ...
      dateLong: "Thursday, June 11, 2026",
      dateShort: "11 June 2026",
      startTime: "8:00 AM",
      clinicName: "Main St. Clinic",
      clinicAddress: "123 Main Street, Anytown, TX 78701",
    },
    phoneOnFile: "(***) ***-4471",
    guardian1: { name: "Maria Rodriguez", relationship: "Mother", mobile: "(305) 555-4471", address: "42 Palm Ave, Miami, FL 33131", occupation: "" },
    // 3 months old as of the visit date above (June 11, 2026) — DOB has
    // to fall before that date, not after it.
    patientDob: "03/11/2026",
    patientSex: "Female",
  ...
  "new-adolescent": {
    scheduling: {
      ...
      providerEmail: "s.jenkins@healthproclinic.com",
      providerSpecialty: "Primary Care",
      dateLong: "Thursday, June 18, 2026",
      dateShort: "18 June 2026",
      startTime: "10:30 AM",
      clinicName: "Main St. Clinic",
      clinicAddress: "123 Main Street, Anytown, TX 78701",
    },
  ...
  "returning-sick": {
    scheduling: {
      ...
      providerEmail: "s.jenkins@healthproclinic.com",
      providerSpecialty: "Primary Care",
      // 3 months after the DOB below, not before it.
      dateLong: "Wednesday, October 7, 2026",
      dateShort: "7 October 2026",
      startTime: "2:00 PM",
      clinicName: "Main St. Clinic",
      clinicAddress: "123 Main Street, Anytown, TX 78701",
    },
  ...
  "returning-sports": {
    scheduling: {
      ...
      providerEmail: "s.jenkins@healthproclinic.com",
      providerSpecialty: "Primary Care",
      dateLong: "Friday, August 14, 2026",
      dateShort: "14 August 2026",
      startTime: "11:00 AM",
      clinicName: "Main St. Clinic",
      clinicAddress: "123 Main Street, Anytown, TX 78701",
    },
